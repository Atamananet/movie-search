...
class Keyboard {
    ...
    keydownHandler(event) {
        ...
        if (event.key === 'Shift') { [...this.characters, ...this.letters].forEach(this.toggleHidden); }
        if (event.code === 'CapsLock') { this.letters.forEach(this.toggleHidden); }
    ...
    mousedownHandler(event) {
        ...
        if (event.target.id === 'CapsLock') { this.letters.forEach(this.toggleHidden); } // toggle letters
        if (event.target.id === 'Shift') { [...this.characters, ...this.letters].forEach(this.toggleHidden); } // toggle letters and simbols
